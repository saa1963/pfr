...
namespace pfr
{
    public partial class frmPreOtchet : Form
    {
        ...
        List<KodNch> knch = new List<KodNch>()
        {
            ...
            new KodNch(){Kod = "НЗ1", Name = "НЗ1 - Незачисление на счет - отсутствие номера счета"},
            new KodNch(){Kod = "НЗ2", Name = "НЗ2 - Незачисление на счет - расхождения в ФИО"},
            new KodNch(){Kod = "НЗ3", Name = "НЗ3 - Незачисление на счет - счет закрыт"},
            new KodNch(){Kod = "НЗ7", Name = "НЗ7 - Незачисление на счет - отметка о смерти"}
        };
