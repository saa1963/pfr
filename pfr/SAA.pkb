...
******************************************************************************/
  ...
  FUNCTION RegisterPfr ( ErrorMsg      OUT VARCHAR2,                           -- Сообщение об ошибке для возврата
    ...
    IS
        ...
        rDeptInfo_in trn_util.t_trn_di_sdr;
        rDeptInfo TS.T_DeptInfo;
    BEGIN
        rDeptInfo_in := TRN_UTIL.GET_RTRN_DI_S(iTrnNum, 0);
        rDeptInfo.cCreatStatus := rDeptInfo_in.cCreatStatus;
        rDeptInfo.cBudCode     := rDeptInfo_in.cBudCode;
        rDeptInfo.cOKATOCode   := rDeptInfo_in.cOKATOCode;
        rDeptInfo.cNalPurp     := rDeptInfo_in.cNalPurp;
        rDeptInfo.cNalPeriod   := rDeptInfo_in.cNalPeriod;
        rDeptInfo.cNalDocNum   := rDeptInfo_in.cNalDocNum;
        rDeptInfo.cNalDocDate  := rDeptInfo_in.cNalDocDate;
        rDeptInfo.cNalType     := rDeptInfo_in.cNalType;
